    ...
    fetch(endpoint)
      ...
      .then(data => {
        ...
        data.forEach(item => {
          ...
          // Tjek om PDF-filen findes
          fetch(fileUrl, { method: "HEAD" })
            .then(res => {
              if (!res.ok) {
                console.warn(`Fil ikke fundet: ${fileUrl}`);
                return;
              }
              ...
              // Tilføj klik-håndtering til tabs
            ...
            .catch(err => {
              console.error(`Fejl ved tjek af filen: ${fileUrl}`, err);
            });
        });
      })
      .catch(error => {
